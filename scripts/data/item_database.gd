...
const ITEMS: Dictionary = {
	...
	"basic_sword":   {"name": "Basic Sword",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "sword", "phys_type": "slash", "value": 50,   "atk_bonus": 5,  "required_skill": "sword", "required_level": 1},
	"iron_sword":    {"name": "Iron Sword",    "type": "weapon", "slot_type": "main_hand", "weapon_type": "sword", "phys_type": "slash", "value": 150,  "atk_bonus": 10, "required_skill": "sword", "required_level": 3},
	"steel_sword":   {"name": "Steel Sword",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "sword", "phys_type": "slash", "value": 400,  "atk_bonus": 15, "required_skill": "sword", "required_level": 5},
	"mithril_sword": {"name": "Mithril Sword", "type": "weapon", "slot_type": "main_hand", "weapon_type": "sword", "phys_type": "slash", "value": 800,  "atk_bonus": 20, "required_skill": "sword", "required_level": 7},
	"dragon_sword":  {"name": "Dragon Sword",  "type": "weapon", "slot_type": "main_hand", "weapon_type": "sword", "phys_type": "slash", "value": 1500, "atk_bonus": 25, "required_skill": "sword", "required_level": 9},
	# Axes (required_skill: "axe")
	"basic_axe":     {"name": "Basic Axe",     "type": "weapon", "slot_type": "main_hand", "weapon_type": "axe", "phys_type": "slash", "value": 50,   "atk_bonus": 5,  "required_skill": "axe", "required_level": 1},
	"iron_axe":      {"name": "Iron Axe",      "type": "weapon", "slot_type": "main_hand", "weapon_type": "axe", "phys_type": "slash", "value": 150,  "atk_bonus": 10, "required_skill": "axe", "required_level": 3},
	"steel_axe":     {"name": "Steel Axe",     "type": "weapon", "slot_type": "main_hand", "weapon_type": "axe", "phys_type": "slash", "value": 400,  "atk_bonus": 15, "required_skill": "axe", "required_level": 5},
	"mithril_axe":   {"name": "Mithril Axe",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "axe", "phys_type": "slash", "value": 800,  "atk_bonus": 20, "required_skill": "axe", "required_level": 7},
	"dragon_axe":    {"name": "Dragon Axe",    "type": "weapon", "slot_type": "main_hand", "weapon_type": "axe", "phys_type": "slash", "value": 1500, "atk_bonus": 25, "required_skill": "axe", "required_level": 9},
	# Maces (required_skill: "mace")
	"basic_mace":    {"name": "Basic Mace",    "type": "weapon", "slot_type": "main_hand", "weapon_type": "mace", "phys_type": "blunt", "value": 50,   "atk_bonus": 5,  "required_skill": "mace", "required_level": 1},
	"iron_mace":     {"name": "Iron Mace",     "type": "weapon", "slot_type": "main_hand", "weapon_type": "mace", "phys_type": "blunt", "value": 150,  "atk_bonus": 10, "required_skill": "mace", "required_level": 3},
	"steel_mace":    {"name": "Steel Mace",    "type": "weapon", "slot_type": "main_hand", "weapon_type": "mace", "phys_type": "blunt", "value": 400,  "atk_bonus": 15, "required_skill": "mace", "required_level": 5},
	"mithril_mace":  {"name": "Mithril Mace",  "type": "weapon", "slot_type": "main_hand", "weapon_type": "mace", "phys_type": "blunt", "value": 800,  "atk_bonus": 20, "required_skill": "mace", "required_level": 7},
	"dragon_mace":   {"name": "Dragon Mace",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "mace", "phys_type": "blunt", "value": 1500, "atk_bonus": 25, "required_skill": "mace", "required_level": 9},
	# Daggers (required_skill: "dagger", attack_speed: 0.7, lower atk_bonus)
	"basic_dagger":   {"name": "Basic Dagger",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "dagger", "phys_type": "pierce", "value": 50,   "atk_bonus": 4,  "attack_speed": 0.7, "required_skill": "dagger", "required_level": 1},
	"iron_dagger":    {"name": "Iron Dagger",    "type": "weapon", "slot_type": "main_hand", "weapon_type": "dagger", "phys_type": "pierce", "value": 150,  "atk_bonus": 8,  "attack_speed": 0.7, "required_skill": "dagger", "required_level": 3},
	"steel_dagger":   {"name": "Steel Dagger",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "dagger", "phys_type": "pierce", "value": 400,  "atk_bonus": 12, "attack_speed": 0.7, "required_skill": "dagger", "required_level": 5},
	"mithril_dagger": {"name": "Mithril Dagger", "type": "weapon", "slot_type": "main_hand", "weapon_type": "dagger", "phys_type": "pierce", "value": 800,  "atk_bonus": 16, "attack_speed": 0.7, "required_skill": "dagger", "required_level": 7},
	"dragon_dagger":  {"name": "Dragon Dagger",  "type": "weapon", "slot_type": "main_hand", "weapon_type": "dagger", "phys_type": "pierce", "value": 1500, "atk_bonus": 20, "attack_speed": 0.7, "required_skill": "dagger", "required_level": 9},
	# Staves (required_skill: "staff")
	"basic_staff":    {"name": "Basic Staff",    "type": "weapon", "slot_type": "main_hand", "weapon_type": "staff", "phys_type": "blunt", "value": 50,   "atk_bonus": 5,  "matk_bonus": 5,  "required_skill": "staff", "required_level": 1},
	"iron_staff":     {"name": "Iron Staff",     "type": "weapon", "slot_type": "main_hand", "weapon_type": "staff", "phys_type": "blunt", "value": 150,  "atk_bonus": 10, "matk_bonus": 10, "required_skill": "staff", "required_level": 3},
	...
	"steel_shield":   {"name": "Steel Shield",   "type": "armor", "slot_type": "off_hand", "value": 400,  "def_bonus": 9,  "mdef_bonus": 0, "required_skill": "con", "required_level": 5},
	"mithril_shield": {"name": "Mithril Shield", "type": "armor", "slot_type": "off_hand", "value": 800,  "def_bonus": 12, "mdef_bonus": 0, "required_skill": "con", "required_level": 7},
	"dragon_shield":  {"name": "Dragon Shield",  "type": "armor", "slot_type": "off_hand", "value": 1500, "def_bonus": 15, "mdef_bonus": 0, "required_skill": "con", "required_level": 9},
	...
	"leather_armor": {"name": "Leather Armor", "type": "armor",  "slot_type": "torso",     "armor_type": "medium", "def_bonus": 3, "value": 40},
	"bone_dagger":   {"name": "Bone Dagger",   "type": "weapon", "slot_type": "main_hand", "weapon_type": "dagger", "phys_type": "pierce", "atk_bonus": 6, "value": 25},
	"copper_sword":  {"name": "Copper Sword",  "type": "weapon", "slot_type": "main_hand", "weapon_type": "sword",  "phys_type": "slash",  "atk_bonus": 7, "value": 60},
}

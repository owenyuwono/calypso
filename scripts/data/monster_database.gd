...
const MONSTERS: Dictionary = {
	...
	"wolf": {
		...
		"aggro_range": 10.0, "attack_range": 2.0, "attack_speed": 1.2,
	...
	"goblin": {
		...
		"aggro_range": 8.0, "attack_range": 2.5, "attack_speed": 1.0,
	...
	"skeleton": {
		...
		"aggro_range": 10.0, "attack_range": 2.5, "attack_speed": 1.0,
	...
	"dark_mage": {
		...
		"aggro_range": 12.0, "attack_range": 3.0, "attack_speed": 2.0,

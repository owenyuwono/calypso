...
static func place_props(ctx: WorldBuilderContext) -> void:
	...
	AssetSpawner.spawn_dungeon_model(ctx, "barrel_large.gltf.glb", Vector3(-44, 0, 25))
	AssetSpawner.spawn_dungeon_model(ctx, "barrel_large.gltf.glb", Vector3(-50, 0, 25))
	AssetSpawner.spawn_dungeon_model(ctx, "barrel_large.gltf.glb", Vector3(-44, 0, 35))
	AssetSpawner.spawn_dungeon_model(ctx, "crates_stacked.gltf.glb", Vector3(-55, 0, 25), 0.4)
	AssetSpawner.spawn_dungeon_model(ctx, "crates_stacked.gltf.glb", Vector3(-50, 0, 35), 0.5)

...
static func build(ctx: WorldBuilderContext) -> void:
	...
	_build_cluster_f(ctx, nav_region, noise, hs)
	_build_guard_posts(ctx, nav_region, noise, hs)
	_build_gatehouse_storage(ctx, nav_region, noise, hs)
	_build_east_gate_expansion(ctx, nav_region, noise, hs)
	_build_north_gate(ctx, nav_region, noise, hs)
	_build_south_gate(ctx, nav_region, noise, hs)


static func _build_cluster_f(ctx: WorldBuilderContext, nav_region: Node, noise: FastNoiseLite, hs: float) -> void:
	# F1 Waystation
...
static func _build_guard_posts(ctx: WorldBuilderContext, nav_region: Node, noise: FastNoiseLite, hs: float) -> void:
	BuildingHelper.create_building(ctx, nav_region,
...
static func _build_gatehouse_storage(ctx: WorldBuilderContext, nav_region: Node, noise: FastNoiseLite, hs: float) -> void:
	BuildingHelper.create_building(ctx, nav_region,
...
static func _build_east_gate_expansion(ctx: WorldBuilderContext, nav_region: Node, noise: FastNoiseLite, hs: float) -> void:
	# Customs House
	BuildingHelper.create_building(ctx, nav_region,
...
static func _build_north_gate(ctx: WorldBuilderContext, nav_region: Node, noise: FastNoiseLite, hs: float) -> void:
	# North Guard Post W
	BuildingHelper.create_building(ctx, nav_region,
...
static func _build_south_gate(ctx: WorldBuilderContext, nav_region: Node, noise: FastNoiseLite, hs: float) -> void:
	# South Guard Post W
	BuildingHelper.create_building(ctx, nav_region,
		Vector3(-3, BuildingHelper.snap_y(noise, -3, 47, hs), 47),
		Vector3(2, 2.5, 2), Color(0.45, 0.42, 0.38), "flat", Color(0.35, 0.32, 0.28),

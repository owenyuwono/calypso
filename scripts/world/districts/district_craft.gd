...
static func build(nav_region: Node3D, noise: FastNoiseLite, hs: float) -> void:
	_build_forge(nav_region, noise, hs)
	_build_workshop_1(nav_region, noise, hs)
	_build_workshop_2(nav_region, noise, hs)
...
static func _build_workshop_1(nav_region: Node3D, noise: FastNoiseLite, hs: float) -> void:
	var ws1 := Node3D.new()
...
static func _build_workshop_2(nav_region: Node3D, noise: FastNoiseLite, hs: float) -> void:
	BuildingHelper.create_building(nav_region,
...
static func _build_forge_props(nav_region: Node3D, noise: FastNoiseLite, hs: float) -> void:
	# Anvil outside forge
...
static func _build_stables(nav_region: Node3D, noise: FastNoiseLite, hs: float) -> void:
	BuildingHelper.create_building(nav_region,
...
static func _build_cluster_d(nav_region: Node3D, noise: FastNoiseLite, hs: float) -> void:
	# D1 Tannery
	BuildingHelper.create_building(nav_region,
